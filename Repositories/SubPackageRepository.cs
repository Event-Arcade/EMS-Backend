...
namespace EMS.BACKEND.API.Repositories
{
    public class SubPackageRepository : ISubPackageRepository
    {
        ...
        //     }
        // }
        public Task<BaseResponseDTO<SubPackage>> CreateAsync(string userId, SubPackage entity)
        {
        ...
        public Task<BaseResponseDTO<IEnumerable<SubPackage>>> FindAllAsync()
        {
            throw new NotImplementedException();
        }

        public Task<BaseResponseDTO<SubPackage>> FindByIdAsync(int id)
        {
            throw new NotImplementedException();
        }

        public Task<BaseResponseDTO<IEnumerable<SubPackage>>> GetSubpackagesByUser(string userId)
        {
            throw new NotImplementedException();
        }

        public Task<BaseResponseDTO<SubPackage>> UpdateAsync(string userId, int id, SubPackage entity)
        {
            throw new NotImplementedException();
        }
    }
